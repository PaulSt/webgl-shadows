CORE FILES:
aztec.html: contains shaders
aztec.js: main file
MouseTrack.js: initalizes mousetracker on click for sphere movement
fbo.js: Shadow Map
cylinder, cube, sphere.js: contain data needed to construct the geometric objects
